...
class CRF(nn.Module):
    def __init__(self, tagset_size: int, gpu: bool):
    ...
    def _calculate_PZ(self, feats: torch.Tensor, mask: torch.Tensor):
        """
            input:
    ...
    def _score_sentence(self, scores: torch.Tensor, mask: torch.Tensor, tags: torch.Tensor):
        """
            input:
    ...
    def neg_log_likelihood_loss(self, feats: torch.Tensor, mask: torch.Tensor, tags: torch.Tensor):
